    ...
    public void run() {
        ...
        mWebView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                documentAdapter.onLayout(null, getPdfPrintAttrs(), null, null, null);
                documentAdapter.onWrite(new PageRange[]{PageRange.ALL_PAGES}, getOutputFileDescriptor(), null, null);
            }
        });
